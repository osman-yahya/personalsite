...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function qc(i,e,t){const n=new Float32Array(vn),r=new B(0,1,0);return new Ot({name:"SphericalGaussianBlur",defines:{n:vn,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:Fi(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function sa(){return new Ot({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Fi(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function oa(){return new Ot({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Fi(),fragmentShader:`
	...
	`}class Ga extends Wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ua(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),h=new qt(c,l),m=new Na(-1,1,1,-1,0,1);let u=null,_=null,v=!1,E,p=null,f=[],b=!1;this.setSize=function(R,M){s.setSize(R,M),o.setSize(R,M);for(let A=0;A<f.length;A++){const T=f[A];T.setSize&&T.setSize(R,M)}},this.setEffects=function(R){f=R,b=f.length>0&&f[0].isRenderPass===!0;const M=s.width,A=s.height;for(let T=0;T<f.length;T++){const C=f[T];C.setSize&&C.setSize(M,A)}},this.begin=function(R,M){if(v||R.toneMapping===0&&f.length===0)return!1;if(p=M,M!==null){const A=M.width,T=M.height;(s.width!==A||s.height!==T)&&this.setSize(A,T)}return b===!1&&R.setRenderTarget(s),E=R.toneMapping,R.toneMapping=0,!0},this.hasRenderPass=function(){return b},this.end=function(R,M){R.toneMapping=E,v=!0;let A=s,T=o;for(let C=0;C<f.length;C++){const g=f[C];if(g.enabled!==!1&&(g.render(R,T,A,M),g.needsSwap!==!1)){const y=A;A=T,T=y}}if(u!==R.outputColorSpace||_!==R.toneMapping){u=R.outputColorSpace,_=R.toneMapping,l.defines={},Oe.getTransfer(u)===Ye&&(l.defines.SRGB_TRANSFER="");const C=eu[_];C&&(l.defines[C]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=A.texture,R.setRenderTarget(p),R.render(h,m),p=null,v=!1},this.isCompositing=function(){return v},this.dispose=function(){s.depthTexture&&s.depthTexture.dispose(),s.dispose(),o.dispose(),c.dispose(),l.dispose()}}const za=new Tt,hr=new zn(1,1),Va=new ba,Ha=new ys,ka=new Ua,la=[],ca=[],ua=new Float32Array(16),fa=new Float32Array(9),da=new Float32Array(4);function Wn(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let a=la[r];if(a===void 0&&(a=new Float32Array(r),la[r]=a),e!==0){n.toArray(a,0);for(let s=1,o=0;s!==e;++s)o+=t,i[s].toArray(a,o)}return a}function ht(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function pt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function Ii(i,e){let t=ca[e];t===void 0&&(t=new Int32Array(e),ca[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function nu(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function iu(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ht(t,e))return;i.uniform2fv(this.addr,e),pt(t,e)}}function ru(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(ht(t,e))return;i.uniform3fv(this.addr,e),pt(t,e)}}function au(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ht(t,e))return;i.uniform4fv(this.addr,e),pt(t,e)}}function su(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(ht(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),pt(t,e)}else{if(ht(t,n))return;da.set(n),i.uniformMatrix2fv(this.addr,!1,da),pt(t,n)}}function ou(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(ht(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),pt(t,e)}else{if(ht(t,n))return;fa.set(n),i.uniformMatrix3fv(this.addr,!1,fa),pt(t,n)}}function lu(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(ht(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),pt(t,e)}else{if(ht(t,n))return;ua.set(n),i.uniformMatrix4fv(this.addr,!1,ua),pt(t,n)}}function cu(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function uu(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ht(t,e))return;i.uniform2iv(this.addr,e),pt(t,e)}}function fu(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(ht(t,e))return;i.uniform3iv(this.addr,e),pt(t,e)}}function du(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ht(t,e))return;i.uniform4iv(this.addr,e),pt(t,e)}}function hu(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function pu(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ht(t,e))return;i.uniform2uiv(this.addr,e),pt(t,e)}}function mu(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(ht(t,e))return;i.uniform3uiv(this.addr,e),pt(t,e)}}function _u(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ht(t,e))return;i.uniform4uiv(this.addr,e),pt(t,e)}}function gu(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let a;this.type===i.SAMPLER_2D_SHADOW?(hr.compareFunction=t.isReversedDepthBuffer()?518:515,a=hr):a=za,t.setTexture2D(e||a,r)}function xu(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||Ha,r)}function vu(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||ka,r)}function Mu(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||Va,r)}function Su(i){switch(i){case 5126:return nu;case 35664:return iu;case 35665:return ru;case 35666:return au;case 35674:return su;case 35675:return ou;case 35676:return lu;case 5124:case 35670:return cu;case 35667:case 35671:return uu;case 35668:case 35672:return fu;case 35669:case 35673:return du;case 5125:return hu;case 36294:return pu;case 36295:return mu;case 36296:return _u;case 35678:case 36198:case 36298:case 36306:case 35682:return gu;case 35679:case 36299:case 36307:return xu;case 35680:case 36300:case 36308:case 36293:return vu;case 36289:case 36303:case 36311:case 36292:return Mu}}function Eu(i,e){i.uniform1fv(this.addr,e)}function Tu(i,e){const t=Wn(e,this.size,2);i.uniform2fv(this.addr,t)}function yu(i,e){const t=Wn(e,this.size,3);i.uniform3fv(this.addr,t)}function Au(i,e){const t=Wn(e,this.size,4);i.uniform4fv(this.addr,t)}function bu(i,e){const t=Wn(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function Ru(i,e){const t=Wn(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Cu(i,e){const t=Wn(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function wu(i,e){i.uniform1iv(this.addr,e)}function Pu(i,e){i.uniform2iv(this.addr,e)}function Du(i,e){i.uniform3iv(this.addr,e)}function Lu(i,e){i.uniform4iv(this.addr,e)}function Uu(i,e){i.uniform1uiv(this.addr,e)}function Fu(i,e){i.uniform2uiv(this.addr,e)}function Iu(i,e){i.uniform3uiv(this.addr,e)}function Nu(i,e){i.uniform4uiv(this.addr,e)}function Ou(i,e,t){const n=this.cache,r=e.length,a=Ii(t,r);ht(n,a)||(i.uniform1iv(this.addr,a),pt(n,a));let s;this.type===i.SAMPLER_2D_SHADOW?s=hr:s=za;for(let o=0;o!==r;++o)t.setTexture2D(e[o]||s,a[o])}function Bu(i,e,t){const n=this.cache,r=e.length,a=Ii(t,r);ht(n,a)||(i.uniform1iv(this.addr,a),pt(n,a));for(let s=0;s!==r;++s)t.setTexture3D(e[s]||Ha,a[s])}function Gu(i,e,t){const n=this.cache,r=e.length,a=Ii(t,r);ht(n,a)||(i.uniform1iv(this.addr,a),pt(n,a));for(let s=0;s!==r;++s)t.setTextureCube(e[s]||ka,a[s])}function zu(i,e,t){const n=this.cache,r=e.length,a=Ii(t,r);ht(n,a)||(i.uniform1iv(this.addr,a),pt(n,a));for(let s=0;s!==r;++s)t.setTexture2DArray(e[s]||Va,a[s])}function Vu(i){switch(i){case 5126:return Eu;case 35664:return Tu;case 35665:return yu;case 35666:return Au;case 35674:return bu;case 35675:return Ru;case 35676:return Cu;case 5124:case 35670:return wu;case 35667:case 35671:return Pu;case 35668:case 35672:return Du;case 35669:case 35673:return Lu;case 5125:return Uu;case 36294:return Fu;case 36295:return Iu;case 36296:return Nu;case 35678:case 36198:case 36298:case 36306:case 35682:return Ou;case 35679:case 36299:case 36307:return Bu;case 35680:case 36300:case 36308:case 36293:return Gu;case 36289:case 36303:case 36311:case 36292:return zu}}class Hu{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Su(t.type)}}class ku{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Vu(t.type)}}class Wu{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let a=0,s=r.length;a!==s;++a){const o=r[a];o.setValue(e,t[o.id],n)}}}const ur=/(\w+)(\])?(\[|\.)?/g;function ha(i,e){i.seq.push(e),i.map[e.id]=e}function Xu(i,e,t){const n=i.name,r=n.length;for(ur.lastIndex=0;;){const a=ur.exec(n),s=ur.lastIndex;let o=a[1];const c=a[2]==="]",l=a[3];if(c&&(o=o|0),l===void 0||l==="["&&s+2===r){ha(t,l===void 0?new Hu(o,i,e):new ku(o,i,e));break}else{let m=t.map[o];m===void 0&&(m=new Wu(o),ha(t,m)),t=m}}}class Ci{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const o=e.getActiveUniform(t,s),c=e.getUniformLocation(t,o.name);Xu(o,c,this)}const r=[],a=[];for(const s of this.seq)s.type===e.SAMPLER_2D_SHADOW||s.type===e.SAMPLER_CUBE_SHADOW||s.type===e.SAMPLER_2D_ARRAY_SHADOW?r.push(s):a.push(s);r.length>0&&(this.seq=r.concat(a))}setValue(e,t,n,r){const a=this.map[t];a!==void 0&&a.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let a=0,s=t.length;a!==s;++a){const o=t[a],c=n[o.id];c.needsUpdate!==!1&&o.setValue(e,c.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,a=e.length;r!==a;++r){const s=e[r];s.id in t&&n.push(s)}return n}}function pa(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const qu=37297;let Yu=0;function Ku(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),a=Math.min(e+6,t.length);for(let s=r;s<a;s++){const o=s+1;n.push(`${o===e?">":" "} ${o}: ${t[s]}`)}return n.join(`
`)}const ma=new we;function Zu(i){Oe._getMatrix(ma,Oe.workingColorSpace,i);const e=`mat3( ${ma.elements.map(t=>t.toFixed(4))} )`;switch(Oe.getTransfer(i)){case Pi:return[e,"LinearTransferOETF"];case Ye:return[e,"sRGBTransferOETF"];default:return Re("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function _a(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),a=(i.getShaderInfoLog(e)||"").trim();if(n&&a==="")return"";const s=/ERROR: 0:(\d+)/.exec(a);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`

`+a+`

`+Ku(i.getShaderSource(e),o)}else return a}function $u(i,e){const t=Zu(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const Ju={1:"Linear",2:"Reinhard",3:"Cineon",4:"ACESFilmic",6:"AgX",7:"Neutral",5:"Custom"};function Qu(i,e){const t=Ju[e];return t===void 0?(Re("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Ri=new B;function ju(){Oe.getLuminanceCoefficients(Ri);const i=Ri.x.toFixed(4),e=Ri.y.toFixed(4),t=Ri.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function ef(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Jn).join(`
`)}function tf(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function nf(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const a=i.getActiveAttrib(e,r),s=a.name;let o=1;a.type===i.FLOAT_MAT2&&(o=2),a.type===i.FLOAT_MAT3&&(o=3),a.type===i.FLOAT_MAT4&&(o=4),t[s]={type:a.type,location:i.getAttribLocation(e,s),locationSize:o}}return t}function Jn(i){return i!==""}function ga(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function xa(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const rf=/^[ \t]*#include +<([\w\d./]+)>/gm;function pr(i){return i.replace(rf,sf)}const af=new Map;function sf(i,e){let t=Ue[e];if(t===void 0){const n=af.get(e);if(n!==void 0)t=Ue[n],Re('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("THREE.WebGLProgram: Can not resolve #include <"+e+">")}return pr(t)}const of=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function va(i){return i.replace(of,lf)}function lf(i,e,t,n){let r="";for(let a=parseInt(e);a<parseInt(t);a++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+a+" ]").replace(/UNROLLED_LOOP_INDEX/g,a);return r}function Ma(i){let e=`precision ${i.precision} float;
...
`;function jf(i){const e=parseInt(i.replace("#",""),16);return new B((e>>16&255)/255,(e>>8&255)/255,(e&255)/255)}function ed(){var i;return typeof window<"u"&&((i=window.matchMedia)==null?void 0:i.call(window,"(prefers-reduced-motion: reduce)").matches)}function td(){var i;return typeof window>"u"?!0:((i=window.matchMedia)==null?void 0:i.call(window,"(pointer: coarse)").matches)||window.innerWidth<768}function nd({canvas:i,fragmentShader:e,uniforms:t,octaves:n=5,maxDpr:r=2,preserveDrawingBuffer:a=!1}){let s;try{s=new $f({canvas:i,alpha:!0,antialias:!1,premultipliedAlpha:!0,depth:!1,stencil:!1,preserveDrawingBuffer:a})}catch{return null}s.setClearAlpha(0);const o=new Ls,c=new vr,l=new ii(2,2),h=new Ot({vertexShader:Jf,fragmentShader:e,uniforms:t,defines:{FBM_OCTAVES:n},glslVersion:dr,transparent:!0,premultipliedAlpha:!0,depthTest:!1,depthWrite:!1}),m=new qt(l,h);m.frustumCulled=!1,o.add(m);const u=Math.min(window.devicePixelRatio||1,r);return s.setPixelRatio(u),{renderer:s,uniforms:t,setSize(_,v){var E;_<=0||v<=0||(s.setSize(_,v,!1),(E=t.uRes)==null||E.value.set(_,v))},render(){s.render(o,c)},dispose(){l.dispose(),h.dispose(),s.dispose()}}}const id=`
  precision highp float;
  ...
  void main() {
    ...
    vec2 uv = vUv;
    // Normalise against the short edge so features keep their size in portrait
    // as well as landscape, instead of smearing on a tall phone hero.
    vec2 p = (uv - 0.5) * uRes / max(min(uRes.x, uRes.y), 1.0);

    float t = uTime * 0.05;

    // Slight rotation keeps the contour bands off the horizontal.
    mat2 tilt = mat2(0.94, 0.34, -0.34, 0.94);
    vec2 sp = tilt * p * 2.3 + uPointer * 0.12;
    sp.y -= uScroll * 0.40;
    sp.y += uFlow * 0.32;

    // Two rounds of domain warping — this is what turns plain noise into
    // something that reads as fabric folding rather than a cloud texture.
    vec2 q = vec2(
      fbm(sp + vec2(0.0, t)),
      fbm(sp + vec2(4.3, 1.7) - t * 0.7)
    );
    vec2 r = vec2(
      fbm(sp + 2.1 * q + vec2(1.7, 9.2) + t * 1.1),
      fbm(sp + 2.1 * q + vec2(8.3, 2.8) - t * 0.9)
    );
    float f = fbm(sp + 2.6 * r);
    f = clamp((f - 0.20) * 2.15, 0.0, 1.0);

    // A slow, large-scale mass underneath so the piece has weight as well as detail.
    float mass = fbm(sp * 0.42 + vec2(t * 0.5, -t * 0.3));
    mass = smoothstep(0.28, 0.78, mass);

    vec3 col = mix(uPaper, uShade, smoothstep(0.08, 0.92, f));
    col = mix(uPaper, col, 0.62 + 0.38 * mass);

    // Accent only rides the ridges, so the warm tone stays sparse.
    float ridge = smoothstep(0.58, 0.88, f) * (1.0 - smoothstep(0.88, 1.0, f));
    col = mix(col, uAccent, ridge * 0.55 * (0.5 + 0.5 * mass));

    float glaze = pow(clamp(dot(normalize(r - 0.5 + 1e-5), vec2(0.6, 0.8)), 0.0, 1.0), 3.0);
    col = mix(col, uPaper, glaze * 0.22);

    // Contour lines, derivative-width so they stay hairline at any DPR.
    float lf = f * uLines;
    float lw = fwidth(lf) * 1.15 + 0.0015;
    float line = 1.0 - smoothstep(0.0, lw, abs(fract(lf) - 0.5));
    col = mix(col, uInk, line * 0.42 * smoothstep(0.03, 0.40, f) * (0.6 + 0.4 * mass));

    float lf2 = f * uLines * 3.0 + 0.5;
    float lw2 = fwidth(lf2) * 1.15 + 0.0015;
    float line2 = 1.0 - smoothstep(0.0, lw2, abs(fract(lf2) - 0.5));
    col = mix(col, uInk, line2 * 0.13 * (0.4 + 0.6 * mass));

    col += (hash21(gl_FragCoord.xy + floor(uTime * 24.0)) - 0.5) * 0.018;

    // Dissolve into the page rather than ending on a hard canvas edge.
    float sides = smoothstep(0.0, 0.16, uv.x) * smoothstep(1.0, 0.84, uv.x);
    float bottom = smoothstep(0.0, 0.30, uv.y);
    float top = smoothstep(1.0, 0.88, uv.y);

    // Open a clearing through the middle so the field frames the headline
    // instead of competing with it.
    // The clearing rounds out on narrow screens, where the headline stacks and
    // needs more vertical room than it does on a wide one.
    float clearY = mix(1.0, 1.9, clamp(aspect - 0.6, 0.0, 1.0));
    float centre = length((uv - 0.5) * vec2(1.15, clearY));
    float clearing = mix(0.34, 1.0, smoothstep(0.16, 0.74, centre));

    float a = uIntro * sides * bottom * top * clearing * 0.94;
...
`,rd=`
  ...
  void main() {
    float aspect = uRes.x / max(uRes.y, 1.0);
    vec2 pa = vec2(vUv.x * aspect, vUv.y);
    vec2 oa = vec2(uOrigin.x * aspect, uOrigin.y);

    // Normalise against the farthest corner so the flood always finishes,
    // whatever corner of the screen it started from.
    float maxD = max(
      max(distance(oa, vec2(0.0, 0.0)), distance(oa, vec2(aspect, 0.0))),
      max(distance(oa, vec2(0.0, 1.0)), distance(oa, vec2(aspect, 1.0)))
    );
    float d = distance(pa, oa) / max(maxD, 0.0001);

    vec2 dir = pa - oa;
    float ang = atan(dir.y, dir.x);

    float n = fbm(vec2(vUv.x * aspect, vUv.y) * 3.4 + uSeed * 7.3 + uTime * 0.08);
    float petals = sin(ang * 3.0 + uSeed * 6.28) * 0.045
                 + sin(ang * 7.0 - uSeed * 4.0) * 0.022;

    float field = d + (n - 0.5) * 0.42 + petals;

    // Over-travel at both ends guarantees full cover and a clean exit.
    float front = uProgress * 1.62 - 0.31;
    float aa = 0.010 + 0.020 * (1.0 - abs(uProgress * 2.0 - 1.0));

    float ink = smoothstep(front + aa, front - aa, field);

    float band = field - front;
    float glow = exp(-abs(band) * 22.0);

    float lf = band * 34.0;
    float lw = fwidth(lf) * 1.4 + 0.002;
    float filament = (1.0 - smoothstep(0.0, lw, abs(fract(lf) - 0.5))) * exp(-abs(band) * 9.0);

    vec3 col = uInk + uEdge * (glow * 0.35 + filament * 0.55);
    col += (hash21(gl_FragCoord.xy + floor(uTime * 30.0)) - 0.5) * 0.02;

    float a = clamp(ink + glow * 0.30 + filament * 0.35, 0.0, 1.0);
    a *= smoothstep(0.0, 0.02, uProgress);

    outColor = vec4(col * a, a); // premultiplied
  }
`;export{id as A,rd as I,Qf as M,We as V,nd as c,td as i,ed as p,jf as s};
